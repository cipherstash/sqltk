...
//! ## VisitorDispatch
//!
//! The [`AstNode`] trait is implemented for all AST node types defined by the
//! `sqlparser` crate. The [`accept`](`AstNode::accept`) method requires an
...
impl<V, N: AstNode<'static>> IsVisitor<V, N>
where
    V: Visitor<'static, N>,
{
