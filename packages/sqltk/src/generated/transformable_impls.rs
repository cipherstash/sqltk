        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::AfterMatchSkip::ToFirst(field0) => {
                let transformed =
                    sqlparser::ast::AfterMatchSkip::ToFirst(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::AfterMatchSkip::ToLast(field0) => {
                let transformed =
                    sqlparser::ast::AfterMatchSkip::ToLast(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::AlterColumnOperation::SetNotNull => {
                transformer.transform(self, sqlparser::ast::AlterColumnOperation::SetNotNull)
            }
            sqlparser::ast::AlterColumnOperation::DropNotNull => {
                transformer.transform(self, sqlparser::ast::AlterColumnOperation::DropNotNull)
            }
            ...
            sqlparser::ast::AlterColumnOperation::DropDefault => {
                transformer.transform(self, sqlparser::ast::AlterColumnOperation::DropDefault)
            }
...
impl<'ast> crate::Transformable<'ast> for sqlparser::ast::AlterTableOperation {
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::AlterTableOperation::DisableRowLevelSecurity => transformer.transform(
                self,
            ...
            sqlparser::ast::AlterTableOperation::DropPrimaryKey => {
                transformer.transform(self, sqlparser::ast::AlterTableOperation::DropPrimaryKey)
            }
            ...
            sqlparser::ast::AlterTableOperation::EnableRowLevelSecurity => transformer.transform(
                self,
...
impl<'ast> crate::Transformable<'ast> for sqlparser::ast::ArgMode {
    ...
    {
        match self {
            sqlparser::ast::ArgMode::In => transformer.transform(self, sqlparser::ast::ArgMode::In),
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::AssignmentTarget::Tuple(field0) => {
                let transformed =
                    sqlparser::ast::AssignmentTarget::Tuple(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::BinaryOperator::DuckIntegerDivide => {
                transformer.transform(self, sqlparser::ast::BinaryOperator::DuckIntegerDivide)
            }
            sqlparser::ast::BinaryOperator::MyIntegerDivide => {
                transformer.transform(self, sqlparser::ast::BinaryOperator::MyIntegerDivide)
            }
            sqlparser::ast::BinaryOperator::Custom(field0) => {
                let transformed =
                    sqlparser::ast::BinaryOperator::Custom(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::BinaryOperator::PGBitwiseShiftLeft => {
                transformer.transform(self, sqlparser::ast::BinaryOperator::PGBitwiseShiftLeft)
            }
            sqlparser::ast::BinaryOperator::PGBitwiseShiftRight => {
                transformer.transform(self, sqlparser::ast::BinaryOperator::PGBitwiseShiftRight)
            }
            ...
            sqlparser::ast::BinaryOperator::PGRegexIMatch => {
                transformer.transform(self, sqlparser::ast::BinaryOperator::PGRegexIMatch)
            }
            sqlparser::ast::BinaryOperator::PGRegexNotMatch => {
                transformer.transform(self, sqlparser::ast::BinaryOperator::PGRegexNotMatch)
            }
            sqlparser::ast::BinaryOperator::PGRegexNotIMatch => {
                transformer.transform(self, sqlparser::ast::BinaryOperator::PGRegexNotIMatch)
            }
            ...
            sqlparser::ast::BinaryOperator::PGNotLikeMatch => {
                transformer.transform(self, sqlparser::ast::BinaryOperator::PGNotLikeMatch)
            }
            sqlparser::ast::BinaryOperator::PGNotILikeMatch => {
                transformer.transform(self, sqlparser::ast::BinaryOperator::PGNotILikeMatch)
            }
            ...
            sqlparser::ast::BinaryOperator::HashLongArrow => {
                transformer.transform(self, sqlparser::ast::BinaryOperator::HashLongArrow)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::CastFormat::Value(field0) => {
                let transformed =
                    sqlparser::ast::CastFormat::Value(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::CeilFloorKind::Scale(field0) => {
                let transformed =
                    sqlparser::ast::CeilFloorKind::Scale(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::ColumnOption::Default(field0) => {
                let transformed =
                    sqlparser::ast::ColumnOption::Default(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::ColumnOption::Ephemeral(field0) => {
                let transformed =
                    sqlparser::ast::ColumnOption::Ephemeral(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::ColumnOption::Alias(field0) => {
                let transformed =
                    sqlparser::ast::ColumnOption::Alias(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::ColumnOption::Check(field0) => {
                let transformed =
                    sqlparser::ast::ColumnOption::Check(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::ColumnOption::Comment(field0) => {
                let transformed =
                    sqlparser::ast::ColumnOption::Comment(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::ColumnOption::OnUpdate(field0) => {
                let transformed =
                    sqlparser::ast::ColumnOption::OnUpdate(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::ColumnOption::Generated {
                ...
                let transformed = sqlparser::ast::ColumnOption::Generated {
                    ...
                    generation_expr_mode: generation_expr_mode.apply_transform(transformer)?,
            ...
            sqlparser::ast::ColumnOption::Options(field0) => {
                let transformed =
                    sqlparser::ast::ColumnOption::Options(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::ColumnOption::Identity(field0) => {
                let transformed =
                    sqlparser::ast::ColumnOption::Identity(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::ColumnOption::OnConflict(field0) => {
                let transformed =
                    sqlparser::ast::ColumnOption::OnConflict(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::ColumnOption::Policy(field0) => {
                let transformed =
                    sqlparser::ast::ColumnOption::Policy(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::ColumnOption::Tags(field0) => {
                let transformed =
                    sqlparser::ast::ColumnOption::Tags(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::CommentDef::WithEq(field0) => {
                let transformed =
                    sqlparser::ast::CommentDef::WithEq(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::CommentDef::WithoutEq(field0) => {
                let transformed =
                    sqlparser::ast::CommentDef::WithoutEq(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::ConflictTarget::Columns(field0) => {
                let transformed =
                    sqlparser::ast::ConflictTarget::Columns(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::CopyLegacyOption::Null(field0) => {
                let transformed =
                    sqlparser::ast::CopyLegacyOption::Null(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::CopyLegacyOption::Csv(field0) => {
                let transformed =
                    sqlparser::ast::CopyLegacyOption::Csv(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::CopyOption::Format(field0) => {
                let transformed =
                    sqlparser::ast::CopyOption::Format(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::CopyOption::Freeze(field0) => {
                let transformed =
                    sqlparser::ast::CopyOption::Freeze(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::CopyOption::Delimiter(field0) => {
                let transformed =
                    sqlparser::ast::CopyOption::Delimiter(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::CopyOption::Null(field0) => {
                let transformed =
                    sqlparser::ast::CopyOption::Null(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::CopyOption::Header(field0) => {
                let transformed =
                    sqlparser::ast::CopyOption::Header(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::CopyOption::Quote(field0) => {
                let transformed =
                    sqlparser::ast::CopyOption::Quote(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::CopyOption::Escape(field0) => {
                let transformed =
                    sqlparser::ast::CopyOption::Escape(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::CopyOption::ForceQuote(field0) => {
                let transformed =
                    sqlparser::ast::CopyOption::ForceQuote(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::CopyOption::ForceNotNull(field0) => {
                let transformed =
                    sqlparser::ast::CopyOption::ForceNotNull(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::CopyOption::ForceNull(field0) => {
                let transformed =
                    sqlparser::ast::CopyOption::ForceNull(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::CopyOption::Encoding(field0) => {
                let transformed =
                    sqlparser::ast::CopyOption::Encoding(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::CopySource::Query(field0) => {
                let transformed =
                    sqlparser::ast::CopySource::Query(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::CreateFunctionUsing::Jar(field0) => {
                let transformed =
                    sqlparser::ast::CreateFunctionUsing::Jar(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::CreateFunctionUsing::File(field0) => {
                let transformed =
                    sqlparser::ast::CreateFunctionUsing::File(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::CreatePolicyType::Restrictive => {
                transformer.transform(self, sqlparser::ast::CreatePolicyType::Restrictive)
            }
        }
    }
}
...
impl<'ast> crate::Transformable<'ast> for sqlparser::ast::CreateTable {
        ...
        T: crate::Transform<'ast>,
    {
        ...
        let transformed = Self {
            ...
            enable_schema_evolution: enable_schema_evolution.apply_transform(transformer)?,
            ...
            with_aggregation_policy: with_aggregation_policy.apply_transform(transformer)?,
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::CreateTableOptions::With(field0) => {
                let transformed =
                    sqlparser::ast::CreateTableOptions::With(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::CteAsMaterialized::Materialized => {
                transformer.transform(self, sqlparser::ast::CteAsMaterialized::Materialized)
            }
            sqlparser::ast::CteAsMaterialized::NotMaterialized => {
                transformer.transform(self, sqlparser::ast::CteAsMaterialized::NotMaterialized)
            }
        }
    }
}
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::DataType::Character(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Character(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::Char(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Char(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::DataType::CharVarying(field0) => {
                let transformed =
                    sqlparser::ast::DataType::CharVarying(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::Varchar(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Varchar(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::Nvarchar(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Nvarchar(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::DataType::CharLargeObject(field0) => {
                let transformed =
                    sqlparser::ast::DataType::CharLargeObject(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::Clob(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Clob(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::Binary(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Binary(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::Varbinary(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Varbinary(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::DataType::Bytes(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Bytes(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::Numeric(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Numeric(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::Decimal(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Decimal(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::BigNumeric(field0) => {
                let transformed =
                    sqlparser::ast::DataType::BigNumeric(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::BigDecimal(field0) => {
                let transformed =
                    sqlparser::ast::DataType::BigDecimal(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::Dec(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Dec(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::Float(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Float(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::TinyInt(field0) => {
                let transformed =
                    sqlparser::ast::DataType::TinyInt(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::UnsignedTinyInt(field0) => {
                let transformed =
                    sqlparser::ast::DataType::UnsignedTinyInt(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::Int2(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Int2(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::UnsignedInt2(field0) => {
                let transformed =
                    sqlparser::ast::DataType::UnsignedInt2(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::SmallInt(field0) => {
                let transformed =
                    sqlparser::ast::DataType::SmallInt(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::DataType::MediumInt(field0) => {
                let transformed =
                    sqlparser::ast::DataType::MediumInt(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::DataType::Int(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Int(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::Int4(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Int4(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::Int8(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Int8(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::DataType::Integer(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Integer(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::UnsignedInt(field0) => {
                let transformed =
                    sqlparser::ast::DataType::UnsignedInt(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::UnsignedInt4(field0) => {
                let transformed =
                    sqlparser::ast::DataType::UnsignedInt4(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::UnsignedInteger(field0) => {
                let transformed =
                    sqlparser::ast::DataType::UnsignedInteger(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::DataType::BigInt(field0) => {
                let transformed =
                    sqlparser::ast::DataType::BigInt(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::UnsignedBigInt(field0) => {
                let transformed =
                    sqlparser::ast::DataType::UnsignedBigInt(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::UnsignedInt8(field0) => {
                let transformed =
                    sqlparser::ast::DataType::UnsignedInt8(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::DataType::Datetime(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Datetime(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::DataType::FixedString(field0) => {
                let transformed =
                    sqlparser::ast::DataType::FixedString(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::DataType::Array(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Array(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::DataType::Tuple(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Tuple(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::DataType::Set(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Set(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::DataType::Union(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Union(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::Nullable(field0) => {
                let transformed =
                    sqlparser::ast::DataType::Nullable(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::DataType::LowCardinality(field0) => {
                let transformed =
                    sqlparser::ast::DataType::LowCardinality(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::DateTimeField::Week(field0) => {
                let transformed =
                    sqlparser::ast::DateTimeField::Week(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::DateTimeField::TimezoneMinute => {
                transformer.transform(self, sqlparser::ast::DateTimeField::TimezoneMinute)
            }
            sqlparser::ast::DateTimeField::TimezoneRegion => {
                transformer.transform(self, sqlparser::ast::DateTimeField::TimezoneRegion)
            }
            ...
            sqlparser::ast::DateTimeField::Custom(field0) => {
                let transformed =
                    sqlparser::ast::DateTimeField::Custom(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::DeclareAssignment::Expr(field0) => {
                let transformed =
                    sqlparser::ast::DeclareAssignment::Expr(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::DeclareAssignment::For(field0) => {
                let transformed =
                    sqlparser::ast::DeclareAssignment::For(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::Deduplicate::ByExpression(field0) => {
                let transformed =
                    sqlparser::ast::Deduplicate::ByExpression(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::Distinct::On(field0) => {
                let transformed =
                    sqlparser::ast::Distinct::On(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::ExcludeSelectItem::Single(field0) => {
                let transformed =
                    sqlparser::ast::ExcludeSelectItem::Single(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::Expr::Identifier(field0) => {
                let transformed =
                    sqlparser::ast::Expr::Identifier(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::Expr::IsFalse(field0) => {
                let transformed =
                    sqlparser::ast::Expr::IsFalse(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Expr::IsNotFalse(field0) => {
                let transformed =
                    sqlparser::ast::Expr::IsNotFalse(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Expr::IsTrue(field0) => {
                let transformed =
                    sqlparser::ast::Expr::IsTrue(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Expr::IsNotTrue(field0) => {
                let transformed =
                    sqlparser::ast::Expr::IsNotTrue(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Expr::IsNull(field0) => {
                let transformed =
                    sqlparser::ast::Expr::IsNull(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Expr::IsNotNull(field0) => {
                let transformed =
                    sqlparser::ast::Expr::IsNotNull(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Expr::IsUnknown(field0) => {
                let transformed =
                    sqlparser::ast::Expr::IsUnknown(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Expr::IsNotUnknown(field0) => {
                let transformed =
                    sqlparser::ast::Expr::IsNotUnknown(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::Expr::Convert {
                ...
                let transformed = sqlparser::ast::Expr::Convert {
                    ...
                    target_before_value: target_before_value.apply_transform(transformer)?,
            ...
            sqlparser::ast::Expr::Nested(field0) => {
                let transformed =
                    sqlparser::ast::Expr::Nested(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Expr::Value(field0) => {
                let transformed = sqlparser::ast::Expr::Value(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::Expr::Subquery(field0) => {
                let transformed =
                    sqlparser::ast::Expr::Subquery(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Expr::GroupingSets(field0) => {
                let transformed =
                    sqlparser::ast::Expr::GroupingSets(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Expr::Cube(field0) => {
                let transformed = sqlparser::ast::Expr::Cube(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Expr::Rollup(field0) => {
                let transformed =
                    sqlparser::ast::Expr::Rollup(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Expr::Tuple(field0) => {
                let transformed = sqlparser::ast::Expr::Tuple(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::Expr::Dictionary(field0) => {
                let transformed =
                    sqlparser::ast::Expr::Dictionary(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::Expr::Interval(field0) => {
                let transformed =
                    sqlparser::ast::Expr::Interval(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Expr::MatchAgainst {
                ...
                let transformed = sqlparser::ast::Expr::MatchAgainst {
                    ...
                    opt_search_modifier: opt_search_modifier.apply_transform(transformer)?,
                };
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::Expr::OuterJoin(field0) => {
                let transformed =
                    sqlparser::ast::Expr::OuterJoin(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Expr::Prior(field0) => {
                let transformed = sqlparser::ast::Expr::Prior(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Expr::Lambda(field0) => {
                let transformed =
                    sqlparser::ast::Expr::Lambda(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::FlushLocation::NoWriteToBinlog => {
                transformer.transform(self, sqlparser::ast::FlushLocation::NoWriteToBinlog)
            }
        ...
        match self {
            ...
            sqlparser::ast::ForClause::Json {
                ...
                let transformed = sqlparser::ast::ForClause::Json {
                    ...
                    include_null_values: include_null_values.apply_transform(transformer)?,
                    without_array_wrapper: without_array_wrapper.apply_transform(transformer)?,
                };
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::ForXml::Raw(field0) => {
                let transformed = sqlparser::ast::ForXml::Raw(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::ForXml::Path(field0) => {
                let transformed =
                    sqlparser::ast::ForXml::Path(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::FormatClause::Identifier(field0) => {
                let transformed =
                    sqlparser::ast::FormatClause::Identifier(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::FromTable::WithoutKeyword(field0) => {
                let transformed =
                    sqlparser::ast::FromTable::WithoutKeyword(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::FunctionArg::Unnamed(field0) => {
                let transformed =
                    sqlparser::ast::FunctionArg::Unnamed(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::FunctionArgExpr::Expr(field0) => {
                let transformed =
                    sqlparser::ast::FunctionArgExpr::Expr(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::FunctionArgOperator::RightArrow => {
                transformer.transform(self, sqlparser::ast::FunctionArgOperator::RightArrow)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::FunctionArguments::List(field0) => {
                let transformed =
                    sqlparser::ast::FunctionArguments::List(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
...
impl<'ast> crate::Transformable<'ast> for sqlparser::ast::FunctionCalledOnNull {
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::FunctionCalledOnNull::ReturnsNullOnNullInput => transformer.transform(
                self,
...
impl<'ast> crate::Transformable<'ast> for sqlparser::ast::FunctionDeterminismSpecifier {
    ...
    {
        match self {
            sqlparser::ast::FunctionDeterminismSpecifier::Deterministic => transformer.transform(
                self,
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::GeneratedExpressionMode::Virtual => {
                transformer.transform(self, sqlparser::ast::GeneratedExpressionMode::Virtual)
            }
            sqlparser::ast::GeneratedExpressionMode::Stored => {
                transformer.transform(self, sqlparser::ast::GeneratedExpressionMode::Stored)
            }
        }
    }
}
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::GrantObjects::Schemas(field0) => {
                let transformed =
                    sqlparser::ast::GrantObjects::Schemas(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::GrantObjects::Sequences(field0) => {
                let transformed =
                    sqlparser::ast::GrantObjects::Sequences(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::GrantObjects::Tables(field0) => {
                let transformed =
                    sqlparser::ast::GrantObjects::Tables(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::GroupByExpr::All(field0) => {
                let transformed =
                    sqlparser::ast::GroupByExpr::All(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::HiveDelimiter::FieldsTerminatedBy => {
                transformer.transform(self, sqlparser::ast::HiveDelimiter::FieldsTerminatedBy)
            }
            sqlparser::ast::HiveDelimiter::FieldsEscapedBy => {
                transformer.transform(self, sqlparser::ast::HiveDelimiter::FieldsEscapedBy)
            }
            sqlparser::ast::HiveDelimiter::CollectionItemsTerminatedBy => transformer.transform(
                self,
                sqlparser::ast::HiveDelimiter::CollectionItemsTerminatedBy,
            ),
            sqlparser::ast::HiveDelimiter::MapKeysTerminatedBy => {
                transformer.transform(self, sqlparser::ast::HiveDelimiter::MapKeysTerminatedBy)
            }
            sqlparser::ast::HiveDelimiter::LinesTerminatedBy => {
                transformer.transform(self, sqlparser::ast::HiveDelimiter::LinesTerminatedBy)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::HiveDescribeFormat::Formatted => {
                transformer.transform(self, sqlparser::ast::HiveDescribeFormat::Formatted)
            }
        }
    }
}
        ...
        match self {
            ...
            sqlparser::ast::HiveDistributionStyle::SKEWED {
                ...
                let transformed = sqlparser::ast::HiveDistributionStyle::SKEWED {
                    ...
                    stored_as_directories: stored_as_directories.apply_transform(transformer)?,
                };
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::IdentityPropertyOrder::NoOrder => {
                transformer.transform(self, sqlparser::ast::IdentityPropertyOrder::NoOrder)
            }
        }
    }
}
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::IndexOption::Using(field0) => {
                let transformed =
                    sqlparser::ast::IndexOption::Using(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::IndexOption::Comment(field0) => {
                let transformed =
                    sqlparser::ast::IndexOption::Comment(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::JoinConstraint::On(field0) => {
                let transformed =
                    sqlparser::ast::JoinConstraint::On(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::JoinConstraint::Using(field0) => {
                let transformed =
                    sqlparser::ast::JoinConstraint::Using(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::JoinOperator::Inner(field0) => {
                let transformed =
                    sqlparser::ast::JoinOperator::Inner(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::JoinOperator::LeftOuter(field0) => {
                let transformed =
                    sqlparser::ast::JoinOperator::LeftOuter(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::JoinOperator::RightOuter(field0) => {
                let transformed =
                    sqlparser::ast::JoinOperator::RightOuter(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::JoinOperator::FullOuter(field0) => {
                let transformed =
                    sqlparser::ast::JoinOperator::FullOuter(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::JoinOperator::LeftAnti(field0) => {
                let transformed =
                    sqlparser::ast::JoinOperator::LeftAnti(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::JoinOperator::RightAnti(field0) => {
                let transformed =
                    sqlparser::ast::JoinOperator::RightAnti(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::JsonTableColumn::Named(field0) => {
                let transformed =
                    sqlparser::ast::JsonTableColumn::Named(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::JsonTableColumn::Nested(field0) => {
                let transformed =
                    sqlparser::ast::JsonTableColumn::Nested(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::JsonTableColumnErrorHandling::Null => {
                transformer.transform(self, sqlparser::ast::JsonTableColumnErrorHandling::Null)
            }
            ...
            sqlparser::ast::JsonTableColumnErrorHandling::Error => {
                transformer.transform(self, sqlparser::ast::JsonTableColumnErrorHandling::Error)
            }
        }
    }
}
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::MacroDefinition::Expr(field0) => {
                let transformed =
                    sqlparser::ast::MacroDefinition::Expr(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::MacroDefinition::Table(field0) => {
                let transformed =
                    sqlparser::ast::MacroDefinition::Table(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::MergeAction::Insert(field0) => {
                let transformed =
                    sqlparser::ast::MergeAction::Insert(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::MergeClauseKind::NotMatchedByTarget => {
                transformer.transform(self, sqlparser::ast::MergeClauseKind::NotMatchedByTarget)
            }
            sqlparser::ast::MergeClauseKind::NotMatchedBySource => {
                transformer.transform(self, sqlparser::ast::MergeClauseKind::NotMatchedBySource)
            }
        }
    }
}
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::MergeInsertKind::Values(field0) => {
                let transformed =
                    sqlparser::ast::MergeInsertKind::Values(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::MinMaxValue::Some(field0) => {
                let transformed =
                    sqlparser::ast::MinMaxValue::Some(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::MysqlInsertPriority::LowPriority => {
                transformer.transform(self, sqlparser::ast::MysqlInsertPriority::LowPriority)
            }
            ...
            sqlparser::ast::MysqlInsertPriority::HighPriority => {
                transformer.transform(self, sqlparser::ast::MysqlInsertPriority::HighPriority)
            }
        }
    }
}
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::OnInsert::OnConflict(field0) => {
                let transformed =
                    sqlparser::ast::OnInsert::OnConflict(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            _ => unreachable!(),
        }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::Owner::Ident(field0) => {
                let transformed =
                    sqlparser::ast::Owner::Ident(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::Partition::Identifier(field0) => {
                let transformed =
                    sqlparser::ast::Partition::Identifier(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Partition::Expr(field0) => {
                let transformed =
                    sqlparser::ast::Partition::Expr(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Partition::Part(field0) => {
                let transformed =
                    sqlparser::ast::Partition::Part(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Partition::Partitions(field0) => {
                let transformed =
                    sqlparser::ast::Partition::Partitions(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::PartitionRangeDirection::Left => {
                transformer.transform(self, sqlparser::ast::PartitionRangeDirection::Left)
            }
            sqlparser::ast::PartitionRangeDirection::Right => {
                transformer.transform(self, sqlparser::ast::PartitionRangeDirection::Right)
            }
        }
    }
}
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::Password::Password(field0) => {
                let transformed =
                    sqlparser::ast::Password::Password(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::PivotValueSource::List(field0) => {
                let transformed =
                    sqlparser::ast::PivotValueSource::List(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::PivotValueSource::Any(field0) => {
                let transformed =
                    sqlparser::ast::PivotValueSource::Any(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::Privileges::Actions(field0) => {
                let transformed =
                    sqlparser::ast::Privileges::Actions(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::ReferentialAction::SetDefault => {
                transformer.transform(self, sqlparser::ast::ReferentialAction::SetDefault)
            }
        }
    }
}
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::RenameSelectItem::Single(field0) => {
                let transformed =
                    sqlparser::ast::RenameSelectItem::Single(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::RepetitionQuantifier::ZeroOrMore => {
                transformer.transform(self, sqlparser::ast::RepetitionQuantifier::ZeroOrMore)
            }
            sqlparser::ast::RepetitionQuantifier::OneOrMore => {
                transformer.transform(self, sqlparser::ast::RepetitionQuantifier::OneOrMore)
            }
            sqlparser::ast::RepetitionQuantifier::AtMostOne => {
                transformer.transform(self, sqlparser::ast::RepetitionQuantifier::AtMostOne)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::ResetConfig::ConfigName(field0) => {
                let transformed =
                    sqlparser::ast::ResetConfig::ConfigName(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::RoleOption::BypassRLS(field0) => {
                let transformed =
                    sqlparser::ast::RoleOption::BypassRLS(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::RoleOption::CreateDB(field0) => {
                let transformed =
                    sqlparser::ast::RoleOption::CreateDB(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::RoleOption::CreateRole(field0) => {
                let transformed =
                    sqlparser::ast::RoleOption::CreateRole(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::RoleOption::Inherit(field0) => {
                let transformed =
                    sqlparser::ast::RoleOption::Inherit(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::RoleOption::Login(field0) => {
                let transformed =
                    sqlparser::ast::RoleOption::Login(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::RoleOption::Password(field0) => {
                let transformed =
                    sqlparser::ast::RoleOption::Password(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::RoleOption::Replication(field0) => {
                let transformed =
                    sqlparser::ast::RoleOption::Replication(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::RoleOption::SuperUser(field0) => {
                let transformed =
                    sqlparser::ast::RoleOption::SuperUser(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::RoleOption::ValidUntil(field0) => {
                let transformed =
                    sqlparser::ast::RoleOption::ValidUntil(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::RowsPerMatch::AllRows(field0) => {
                let transformed =
                    sqlparser::ast::RowsPerMatch::AllRows(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::SchemaName::Simple(field0) => {
                let transformed =
                    sqlparser::ast::SchemaName::Simple(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::SearchModifier::InNaturalLanguageMode => {
                transformer.transform(self, sqlparser::ast::SearchModifier::InNaturalLanguageMode)
            }
            sqlparser::ast::SearchModifier::InNaturalLanguageModeWithQueryExpansion => transformer
                .transform(
                    self,
                    sqlparser::ast::SearchModifier::InNaturalLanguageModeWithQueryExpansion,
                ),
            sqlparser::ast::SearchModifier::InBooleanMode => {
                transformer.transform(self, sqlparser::ast::SearchModifier::InBooleanMode)
            }
            sqlparser::ast::SearchModifier::WithQueryExpansion => {
                transformer.transform(self, sqlparser::ast::SearchModifier::WithQueryExpansion)
            }
        }
    }
}
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::SelectItem::UnnamedExpr(field0) => {
                let transformed =
                    sqlparser::ast::SelectItem::UnnamedExpr(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::SelectItem::Wildcard(field0) => {
                let transformed =
                    sqlparser::ast::SelectItem::Wildcard(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::SequenceOptions::MinValue(field0) => {
                let transformed =
                    sqlparser::ast::SequenceOptions::MinValue(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::SequenceOptions::MaxValue(field0) => {
                let transformed =
                    sqlparser::ast::SequenceOptions::MaxValue(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::SequenceOptions::Cache(field0) => {
                let transformed =
                    sqlparser::ast::SequenceOptions::Cache(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::SequenceOptions::Cycle(field0) => {
                let transformed =
                    sqlparser::ast::SequenceOptions::Cycle(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::SetConfigValue::Value(field0) => {
                let transformed =
                    sqlparser::ast::SetConfigValue::Value(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::SetExpr::Select(field0) => {
                let transformed =
                    sqlparser::ast::SetExpr::Select(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::SetExpr::Query(field0) => {
                let transformed =
                    sqlparser::ast::SetExpr::Query(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::SetExpr::Values(field0) => {
                let transformed =
                    sqlparser::ast::SetExpr::Values(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::SetExpr::Insert(field0) => {
                let transformed =
                    sqlparser::ast::SetExpr::Insert(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::SetExpr::Update(field0) => {
                let transformed =
                    sqlparser::ast::SetExpr::Update(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::SetExpr::Table(field0) => {
                let transformed =
                    sqlparser::ast::SetExpr::Table(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::SetQuantifier::DistinctByName => {
                transformer.transform(self, sqlparser::ast::SetQuantifier::DistinctByName)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::ShowStatementFilter::Like(field0) => {
                let transformed =
                    sqlparser::ast::ShowStatementFilter::Like(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::SqlOption::Clustered(field0) => {
                let transformed =
                    sqlparser::ast::SqlOption::Clustered(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::SqlOption::Ident(field0) => {
                let transformed =
                    sqlparser::ast::SqlOption::Ident(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::Statement::Query(field0) => {
                let transformed =
                    sqlparser::ast::Statement::Query(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Statement::Insert(field0) => {
                let transformed =
                    sqlparser::ast::Statement::Insert(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::Statement::Call(field0) => {
                let transformed =
                    sqlparser::ast::Statement::Call(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::Statement::CopyIntoSnowflake {
                ...
                let transformed = sqlparser::ast::Statement::CopyIntoSnowflake {
                    ...
                    from_transformations: from_transformations.apply_transform(transformer)?,
            ...
            sqlparser::ast::Statement::Delete(field0) => {
                let transformed =
                    sqlparser::ast::Statement::Delete(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Statement::CreateView {
                ...
                let transformed = sqlparser::ast::Statement::CreateView {
                    ...
                    cluster_by: cluster_by.apply_transform(transformer)?,
                    comment: comment.apply_transform(transformer)?,
                    with_no_schema_binding: with_no_schema_binding.apply_transform(transformer)?,
                    if_not_exists: if_not_exists.apply_transform(transformer)?,
                    temporary: temporary.apply_transform(transformer)?,
                    to: to.apply_transform(transformer)?,
                };
            ...
            sqlparser::ast::Statement::CreateTable(field0) => {
                let transformed =
                    sqlparser::ast::Statement::CreateTable(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::Statement::CreateIndex(field0) => {
                let transformed =
                    sqlparser::ast::Statement::CreateIndex(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Statement::CreateRole {
                ...
                let transformed = sqlparser::ast::Statement::CreateRole {
                    ...
                    authorization_owner: authorization_owner.apply_transform(transformer)?,
                };
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::Statement::Use(field0) => {
                let transformed =
                    sqlparser::ast::Statement::Use(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::Statement::CreateTrigger {
                ...
                let transformed = sqlparser::ast::Statement::CreateTrigger {
                    ...
                    table_name: table_name.apply_transform(transformer)?,
                    referenced_table_name: referenced_table_name.apply_transform(transformer)?,
            ...
            sqlparser::ast::Statement::CreateStage {
                ...
                let transformed = sqlparser::ast::Statement::CreateStage {
                    ...
                    name: name.apply_transform(transformer)?,
                    stage_params: stage_params.apply_transform(transformer)?,
                    directory_table_params: directory_table_params.apply_transform(transformer)?,
                    file_format: file_format.apply_transform(transformer)?,
                    copy_options: copy_options.apply_transform(transformer)?,
                    comment: comment.apply_transform(transformer)?,
                };
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::StructBracketKind::Parentheses => {
                transformer.transform(self, sqlparser::ast::StructBracketKind::Parentheses)
            }
            sqlparser::ast::StructBracketKind::AngleBrackets => {
                transformer.transform(self, sqlparser::ast::StructBracketKind::AngleBrackets)
            }
        }
    }
}
        ...
        match self {
            ...
            sqlparser::ast::TableFactor::Pivot {
                ...
                let transformed = sqlparser::ast::TableFactor::Pivot {
                    table: table.apply_transform(transformer)?,
                    aggregate_functions: aggregate_functions.apply_transform(transformer)?,
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::TimezoneInfo::WithoutTimeZone => {
                transformer.transform(self, sqlparser::ast::TimezoneInfo::WithoutTimeZone)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::TopQuantity::Expr(field0) => {
                let transformed =
                    sqlparser::ast::TopQuantity::Expr(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::TopQuantity::Constant(field0) => {
                let transformed =
                    sqlparser::ast::TopQuantity::Constant(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::TransactionAccessMode::ReadOnly => {
                transformer.transform(self, sqlparser::ast::TransactionAccessMode::ReadOnly)
            }
            sqlparser::ast::TransactionAccessMode::ReadWrite => {
                transformer.transform(self, sqlparser::ast::TransactionAccessMode::ReadWrite)
            }
        }
    }
}
...
impl<'ast> crate::Transformable<'ast> for sqlparser::ast::TransactionIsolationLevel {
    ...
    {
        match self {
            sqlparser::ast::TransactionIsolationLevel::ReadUncommitted => transformer.transform(
                self,
            ...
            sqlparser::ast::TransactionIsolationLevel::RepeatableRead => transformer.transform(
                self,
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::TransactionModifier::Deferred => {
                transformer.transform(self, sqlparser::ast::TransactionModifier::Deferred)
            }
            sqlparser::ast::TransactionModifier::Immediate => {
                transformer.transform(self, sqlparser::ast::TransactionModifier::Immediate)
            }
            sqlparser::ast::TransactionModifier::Exclusive => {
                transformer.transform(self, sqlparser::ast::TransactionModifier::Exclusive)
            }
        }
    }
}
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::TriggerEvent::Update(field0) => {
                let transformed =
                    sqlparser::ast::TriggerEvent::Update(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::TriggerExecBodyType::Function => {
                transformer.transform(self, sqlparser::ast::TriggerExecBodyType::Function)
            }
            sqlparser::ast::TriggerExecBodyType::Procedure => {
                transformer.transform(self, sqlparser::ast::TriggerExecBodyType::Procedure)
            }
        }
    }
}
...
impl<'ast> crate::Transformable<'ast> for sqlparser::ast::TriggerReferencing {
        ...
        T: crate::Transform<'ast>,
    {
        ...
        let transformed = Self {
            ...
            transition_relation_name: transition_relation_name.apply_transform(transformer)?,
        };
        transformer.transform(self, transformed)
    }
}
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::TriggerReferencingType::OldTable => {
                transformer.transform(self, sqlparser::ast::TriggerReferencingType::OldTable)
            }
            sqlparser::ast::TriggerReferencingType::NewTable => {
                transformer.transform(self, sqlparser::ast::TriggerReferencingType::NewTable)
            }
        }
    }
}
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::TruncateCascadeOption::Cascade => {
                transformer.transform(self, sqlparser::ast::TruncateCascadeOption::Cascade)
            }
            sqlparser::ast::TruncateCascadeOption::Restrict => {
                transformer.transform(self, sqlparser::ast::TruncateCascadeOption::Restrict)
            }
        }
    }
}
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::TruncateIdentityOption::Restart => {
                transformer.transform(self, sqlparser::ast::TruncateIdentityOption::Restart)
            }
            sqlparser::ast::TruncateIdentityOption::Continue => {
                transformer.transform(self, sqlparser::ast::TruncateIdentityOption::Continue)
            }
        }
    }
}
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::UnaryOperator::PGPostfixFactorial => {
                transformer.transform(self, sqlparser::ast::UnaryOperator::PGPostfixFactorial)
            }
            sqlparser::ast::UnaryOperator::PGPrefixFactorial => {
                transformer.transform(self, sqlparser::ast::UnaryOperator::PGPrefixFactorial)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::Use::Catalog(field0) => {
                let transformed =
                    sqlparser::ast::Use::Catalog(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Use::Schema(field0) => {
                let transformed = sqlparser::ast::Use::Schema(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Use::Database(field0) => {
                let transformed =
                    sqlparser::ast::Use::Database(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::Use::Object(field0) => {
                let transformed = sqlparser::ast::Use::Object(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::Value::SingleQuotedString(field0) => {
                let transformed =
                    sqlparser::ast::Value::SingleQuotedString(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Value::DollarQuotedString(field0) => {
                let transformed =
                    sqlparser::ast::Value::DollarQuotedString(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::ast::Value::HexStringLiteral(field0) => {
                let transformed =
                    sqlparser::ast::Value::HexStringLiteral(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Value::DoubleQuotedString(field0) => {
                let transformed =
                    sqlparser::ast::Value::DoubleQuotedString(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Value::Boolean(field0) => {
                let transformed =
                    sqlparser::ast::Value::Boolean(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::Value::Null => transformer.transform(self, sqlparser::ast::Value::Null),
            sqlparser::ast::Value::Placeholder(field0) => {
                let transformed =
                    sqlparser::ast::Value::Placeholder(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            sqlparser::ast::WindowType::WindowSpec(field0) => {
                let transformed =
                    sqlparser::ast::WindowType::WindowSpec(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            sqlparser::ast::WindowType::NamedWindow(field0) => {
                let transformed =
                    sqlparser::ast::WindowType::NamedWindow(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
        }
    }
    ...
    for sqlparser::ast::helpers::stmt_data_loading::DataLoadingOptionType
{
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::ast::helpers::stmt_data_loading::DataLoadingOptionType::ENUM => transformer
                .transform(
                    self,
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::keywords::Keyword::ARRAY_MAX_CARDINALITY => {
                transformer.transform(self, sqlparser::keywords::Keyword::ARRAY_MAX_CARDINALITY)
            }
            ...
            sqlparser::keywords::Keyword::CHANGE_TRACKING => {
                transformer.transform(self, sqlparser::keywords::Keyword::CHANGE_TRACKING)
            }
            ...
            sqlparser::keywords::Keyword::CHARACTER_LENGTH => {
                transformer.transform(self, sqlparser::keywords::Keyword::CHARACTER_LENGTH)
            }
            ...
            sqlparser::keywords::Keyword::CURRENT_CATALOG => {
                transformer.transform(self, sqlparser::keywords::Keyword::CURRENT_CATALOG)
            }
            sqlparser::keywords::Keyword::CURRENT_DATE => {
                transformer.transform(self, sqlparser::keywords::Keyword::CURRENT_DATE)
            }
            sqlparser::keywords::Keyword::CURRENT_DEFAULT_TRANSFORM_GROUP => transformer.transform(
                self,
            ...
            sqlparser::keywords::Keyword::CURRENT_TIMESTAMP => {
                transformer.transform(self, sqlparser::keywords::Keyword::CURRENT_TIMESTAMP)
            }
            ...
            sqlparser::keywords::Keyword::DATA_RETENTION_TIME_IN_DAYS => transformer.transform(
                self,
            ...
            sqlparser::keywords::Keyword::DEFAULT_DDL_COLLATION => {
                transformer.transform(self, sqlparser::keywords::Keyword::DEFAULT_DDL_COLLATION)
            }
            ...
            sqlparser::keywords::Keyword::ENABLE_SCHEMA_EVOLUTION => {
                transformer.transform(self, sqlparser::keywords::Keyword::ENABLE_SCHEMA_EVOLUTION)
            }
            ...
            sqlparser::keywords::Keyword::INCLUDE_NULL_VALUES => {
                transformer.transform(self, sqlparser::keywords::Keyword::INCLUDE_NULL_VALUES)
            }
            ...
            sqlparser::keywords::Keyword::MANAGEDLOCATION => {
                transformer.transform(self, sqlparser::keywords::Keyword::MANAGEDLOCATION)
            }
            ...
            sqlparser::keywords::Keyword::MATCH_CONDITION => {
                transformer.transform(self, sqlparser::keywords::Keyword::MATCH_CONDITION)
            }
            sqlparser::keywords::Keyword::MATCH_RECOGNIZE => {
                transformer.transform(self, sqlparser::keywords::Keyword::MATCH_RECOGNIZE)
            }
            ...
            sqlparser::keywords::Keyword::MAX_DATA_EXTENSION_TIME_IN_DAYS => transformer.transform(
                self,
            ...
            sqlparser::keywords::Keyword::NO_WRITE_TO_BINLOG => {
                transformer.transform(self, sqlparser::keywords::Keyword::NO_WRITE_TO_BINLOG)
            }
            ...
            sqlparser::keywords::Keyword::OCCURRENCES_REGEX => {
                transformer.transform(self, sqlparser::keywords::Keyword::OCCURRENCES_REGEX)
            }
            ...
            sqlparser::keywords::Keyword::OPTIMIZER_COSTS => {
                transformer.transform(self, sqlparser::keywords::Keyword::OPTIMIZER_COSTS)
            }
            ...
            sqlparser::keywords::Keyword::PERCENTILE_CONT => {
                transformer.transform(self, sqlparser::keywords::Keyword::PERCENTILE_CONT)
            }
            sqlparser::keywords::Keyword::PERCENTILE_DISC => {
                transformer.transform(self, sqlparser::keywords::Keyword::PERCENTILE_DISC)
            }
            ...
            sqlparser::keywords::Keyword::SERDEPROPERTIES => {
                transformer.transform(self, sqlparser::keywords::Keyword::SERDEPROPERTIES)
            }
            ...
            sqlparser::keywords::Keyword::STORAGE_INTEGRATION => {
                transformer.transform(self, sqlparser::keywords::Keyword::STORAGE_INTEGRATION)
            }
            ...
            sqlparser::keywords::Keyword::SUBSTRING_REGEX => {
                transformer.transform(self, sqlparser::keywords::Keyword::SUBSTRING_REGEX)
            }
            ...
            sqlparser::keywords::Keyword::TIMEZONE_MINUTE => {
                transformer.transform(self, sqlparser::keywords::Keyword::TIMEZONE_MINUTE)
            }
            ...
            sqlparser::keywords::Keyword::TRANSLATE_REGEX => {
                transformer.transform(self, sqlparser::keywords::Keyword::TRANSLATE_REGEX)
            }
            ...
            sqlparser::keywords::Keyword::VALIDATION_MODE => {
                transformer.transform(self, sqlparser::keywords::Keyword::VALIDATION_MODE)
            }
            ...
            sqlparser::keywords::Keyword::WITHOUT_ARRAY_WRAPPER => {
                transformer.transform(self, sqlparser::keywords::Keyword::WITHOUT_ARRAY_WRAPPER)
            }
        ...
        T: crate::Transform<'ast>,
    {
        match self {
            ...
            sqlparser::tokenizer::Token::Word(field0) => {
                let transformed =
                    sqlparser::tokenizer::Token::Word(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::tokenizer::Token::Char(field0) => {
                let transformed =
                    sqlparser::tokenizer::Token::Char(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::tokenizer::Token::Whitespace(field0) => {
                let transformed =
                    sqlparser::tokenizer::Token::Whitespace(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
            ...
            sqlparser::tokenizer::Token::ExclamationMarkTilde => {
                transformer.transform(self, sqlparser::tokenizer::Token::ExclamationMarkTilde)
            }
            sqlparser::tokenizer::Token::ExclamationMarkTildeAsterisk => transformer.transform(
                self,
            ...
            sqlparser::tokenizer::Token::DoubleTildeAsterisk => {
                transformer.transform(self, sqlparser::tokenizer::Token::DoubleTildeAsterisk)
            }
            ...
            sqlparser::tokenizer::Token::DoubleExclamationMark => {
                transformer.transform(self, sqlparser::tokenizer::Token::DoubleExclamationMark)
            }
            ...
            sqlparser::tokenizer::Token::Placeholder(field0) => {
                let transformed =
                    sqlparser::tokenizer::Token::Placeholder(field0.apply_transform(transformer)?);
                transformer.transform(self, transformed)
            }
