        ...
        let transformed = {
            match self {
                sqltk_parser::ast::AccessExpr::Dot(field0) => {
                    sqltk_parser::ast::AccessExpr::Dot(
        ...
        let transformed = {
            match self {
                ...
                sqltk_parser::ast::Action::ApplyBudget => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::Action::ApplyBudget)?
                }
                sqltk_parser::ast::Action::AttachListing => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::Action::AttachListing)?
                }
                sqltk_parser::ast::Action::AttachPolicy => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::Action::AttachPolicy)?
                }
                ...
                sqltk_parser::ast::Action::EvolveSchema => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::Action::EvolveSchema)?
                }
                ...
                sqltk_parser::ast::Action::Failover => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::Action::Failover)?
                }
                ...
                sqltk_parser::ast::Action::ImportShare => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::Action::ImportShare)?
                }
                ...
                sqltk_parser::ast::Action::ManageReleases => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::Action::ManageReleases)?
                }
                sqltk_parser::ast::Action::ManageVersions => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::Action::ManageVersions)?
                }
                ...
                sqltk_parser::ast::Action::Ownership => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::Action::Ownership)?
                }
                ...
                sqltk_parser::ast::Action::ReadSession => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::Action::ReadSession)?
                }
                ...
                sqltk_parser::ast::Action::Replicate => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::Action::Replicate)?
                }
                sqltk_parser::ast::Action::ResolveAll => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::Action::ResolveAll)?
                }
                sqltk_parser::ast::Action::Role { role } => {
                    sqltk_parser::ast::Action::Role {
                        role: role.apply_transform_with_path(transformer, node_path)?,
                    }
                }
        ...
        let transformed = {
            match self {
                ...
                sqltk_parser::ast::ActionApplyType::Tag => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::ActionApplyType::Tag)?
                }
            }
        };
        let transformed = transformer.transform(node_path, transformed)?;
...
impl<'ast> crate::Transformable<'ast> for sqltk_parser::ast::AlterTableLock {
        ...
        T: crate::Transform<'ast>,
    {
        ...
        let transformed = {
            match self {
                sqltk_parser::ast::AlterTableLock::Default => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::ast::AlterTableLock::Default,
                ...
                sqltk_parser::ast::AlterTableLock::None => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::AlterTableLock::None)?
                }
                sqltk_parser::ast::AlterTableLock::Shared => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::AlterTableLock::Shared)?
                }
                sqltk_parser::ast::AlterTableLock::Exclusive => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::ast::AlterTableLock::Exclusive,
...
impl<'ast> crate::Transformable<'ast> for sqltk_parser::ast::AlterTypeAddValue {
        ...
        T: crate::Transform<'ast>,
    {
        node_path.push(self);
        let transformed = {
            let Self { if_not_exists, value, position } = self;
            Self {
                if_not_exists: if_not_exists
                    .apply_transform_with_path(transformer, node_path)?,
                value: value.apply_transform_with_path(transformer, node_path)?,
...
impl<'ast> crate::Transformable<'ast> for sqltk_parser::ast::BeginEndStatements {
        ...
        T: crate::Transform<'ast>,
    {
        node_path.push(self);
        let transformed = {
            let Self { begin_token, statements, end_token } = self;
            Self {
        ...
        let transformed = {
            match self {
                ...
                sqltk_parser::ast::BinaryLength::Max => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::BinaryLength::Max)?
                }
            }
        };
        let transformed = transformer.transform(node_path, transformed)?;
        ...
        let transformed = {
            match self {
                ...
                sqltk_parser::ast::BinaryOperator::At => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::BinaryOperator::At)?
                }
                ...
                sqltk_parser::ast::BinaryOperator::Assignment => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::ast::BinaryOperator::Assignment,
...
impl<'ast> crate::Transformable<'ast> for sqltk_parser::ast::ConditionalStatementBlock {
        ...
        T: crate::Transform<'ast>,
    {
        node_path.push(self);
        let transformed = {
            let Self { start_token, condition, then_token, conditional_statements } = self;
            Self {
        ...
        T: crate::Transform<'ast>,
    {
        ...
        let transformed = {
            match self {
                ...
                sqltk_parser::ast::ContextModifier::Global => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::ast::ContextModifier::Global,
...
impl<'ast> crate::Transformable<'ast> for sqltk_parser::ast::CreateDomain {
        ...
        T: crate::Transform<'ast>,
    {
        node_path.push(self);
        let transformed = {
            let Self { name, data_type, collation, default, constraints } = self;
            Self {
                name: name.apply_transform_with_path(transformer, node_path)?,
                data_type: data_type.apply_transform_with_path(transformer, node_path)?,
...
impl<'ast> crate::Transformable<'ast> for sqltk_parser::ast::CreateViewParams {
        ...
        T: crate::Transform<'ast>,
    {
        node_path.push(self);
        let transformed = {
            let Self { algorithm, definer, security } = self;
            Self {
        ...
        let transformed = {
            match self {
                sqltk_parser::ast::DataType::Table(field0) => {
                    sqltk_parser::ast::DataType::Table(
                        field0.apply_transform_with_path(transformer, node_path)?,
                    )
                }
                ...
                sqltk_parser::ast::DataType::UTinyInt => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::DataType::UTinyInt)?
                }
                ...
                sqltk_parser::ast::DataType::USmallInt => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::DataType::USmallInt)?
                }
                ...
                sqltk_parser::ast::DataType::HugeInt => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::DataType::HugeInt)?
                }
                sqltk_parser::ast::DataType::UHugeInt => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::DataType::UHugeInt)?
                }
                ...
                sqltk_parser::ast::DataType::UBigInt => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::DataType::UBigInt)?
                }
                ...
                sqltk_parser::ast::DataType::Signed => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::DataType::Signed)?
                }
                ...
                sqltk_parser::ast::DataType::Unsigned => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::DataType::Unsigned)?
                }
                ...
                sqltk_parser::ast::DataType::TimestampNtz => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::DataType::TimestampNtz)?
                }
                ...
                sqltk_parser::ast::DataType::VarBit(field0) => {
                    sqltk_parser::ast::DataType::VarBit(
                        field0.apply_transform_with_path(transformer, node_path)?,
                    )
                }
                ...
                sqltk_parser::ast::DataType::AnyType => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::DataType::AnyType)?
                }
        ...
        let transformed = {
            match self {
                ...
                sqltk_parser::ast::DateTimeField::Years => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::DateTimeField::Years)?
                }
                ...
                sqltk_parser::ast::DateTimeField::Weeks => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::DateTimeField::Weeks)?
                }
                ...
                sqltk_parser::ast::DateTimeField::Days => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::DateTimeField::Days)?
                }
                ...
                sqltk_parser::ast::DateTimeField::Hours => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::DateTimeField::Hours)?
                }
...
impl<'ast> crate::Transformable<'ast> for sqltk_parser::ast::DropDomain {
        ...
        T: crate::Transform<'ast>,
    {
        node_path.push(self);
        let transformed = {
            let Self { if_exists, name, drop_behavior } = self;
            Self {
        ...
        T: crate::Transform<'ast>,
    {
        ...
        let transformed = {
            match self {
                ...
                sqltk_parser::ast::Expr::Case { operand, conditions, else_result } => {
        ...
        let transformed = {
            match self {
                sqltk_parser::ast::FetchPosition::From => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::FetchPosition::From)?
                }
                sqltk_parser::ast::FetchPosition::In => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::FetchPosition::In)?
                }
            }
        };
        let transformed = transformer.transform(node_path, transformed)?;
        ...
        let transformed = {
            match self {
                sqltk_parser::ast::GranteesType::Role => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::GranteesType::Role)?
                }
                sqltk_parser::ast::GranteesType::Share => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::GranteesType::Share)?
                }
                sqltk_parser::ast::GranteesType::User => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::GranteesType::User)?
                }
                sqltk_parser::ast::GranteesType::Group => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::GranteesType::Group)?
                }
                sqltk_parser::ast::GranteesType::Public => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::GranteesType::Public)?
                }
                ...
                sqltk_parser::ast::GranteesType::None => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::GranteesType::None)?
                }
            }
        };
        let transformed = transformer.transform(node_path, transformed)?;
...
impl<'ast> crate::Transformable<'ast> for sqltk_parser::ast::IfStatement {
        ...
        T: crate::Transform<'ast>,
    {
        node_path.push(self);
        let transformed = {
            let Self { if_block, elseif_blocks, else_block, end_token } = self;
            Self {
...
impl<'ast> crate::Transformable<'ast> for sqltk_parser::ast::IndexColumn {
        ...
        T: crate::Transform<'ast>,
    {
        node_path.push(self);
        let transformed = {
            let Self { column, operator_class } = self;
            Self {
        ...
        let transformed = {
            match self {
                ...
                sqltk_parser::ast::IndexType::SPGiST => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::IndexType::SPGiST)?
                }
                ...
                sqltk_parser::ast::IndexType::Bloom => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::IndexType::Bloom)?
                }
        ...
        T: crate::Transform<'ast>,
    {
        ...
        let transformed = {
            match self {
                ...
                sqltk_parser::ast::ObjectType::MaterializedView => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::ast::ObjectType::MaterializedView,
...
impl<'ast> crate::Transformable<'ast> for sqltk_parser::ast::OrderByExpr {
        ...
        T: crate::Transform<'ast>,
    {
        node_path.push(self);
        let transformed = {
            let Self { expr, options, with_fill } = self;
            Self {
                expr: expr.apply_transform_with_path(transformer, node_path)?,
                options: options.apply_transform_with_path(transformer, node_path)?,
        ...
        let transformed = {
            match self {
                sqltk_parser::ast::OrderByKind::All(field0) => {
                    sqltk_parser::ast::OrderByKind::All(
                        field0.apply_transform_with_path(transformer, node_path)?,
                    )
                }
...
impl<'ast> crate::Transformable<'ast> for sqltk_parser::ast::OutputClause {
        ...
        T: crate::Transform<'ast>,
    {
        node_path.push(self);
        let transformed = {
            let Self { select_items, into_table } = self;
            Self {
        ...
        let transformed = {
            match self {
                sqltk_parser::ast::RaisErrorOption::Log => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::RaisErrorOption::Log)?
                }
...
#[automatically_derived]
impl<'ast> crate::Transformable<'ast>
for sqltk_parser::ast::SelectItemQualifiedWildcardKind {
    fn apply_transform_with_path<T>(
        &'ast self,
        transformer: &mut T,
        node_path: &mut crate::NodePath<'ast>,
        ...
        T: crate::Transform<'ast>,
    {
        ...
        let transformed = {
            match self {
                ...
                sqltk_parser::ast::Set::SetNames { charset_name, collation_name } => {
                ...
                sqltk_parser::ast::Set::SetTransaction { modes, snapshot, session } => {
        ...
        T: crate::Transform<'ast>,
    {
        ...
        let transformed = {
            match self {
                ...
                sqltk_parser::ast::SetExpr::Delete(field0) => {
                    sqltk_parser::ast::SetExpr::Delete(
                        field0.apply_transform_with_path(transformer, node_path)?,
                    )
                }
        ...
        let transformed = {
            match self {
                ...
                sqltk_parser::ast::SetOperator::Minus => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::SetOperator::Minus)?
                }
            }
        };
        let transformed = transformer.transform(node_path, transformed)?;
...
#[automatically_derived]
impl<'ast> crate::Transformable<'ast>
for sqltk_parser::ast::SetSessionParamIdentityInsert {
    fn apply_transform_with_path<T>(
        &'ast self,
        transformer: &mut T,
        node_path: &mut crate::NodePath<'ast>,
...
impl<'ast> crate::Transformable<'ast> for sqltk_parser::ast::ShowObjects {
        ...
        T: crate::Transform<'ast>,
    {
        node_path.push(self);
        let transformed = {
            let Self { terse, show_options } = self;
            Self {
        ...
        T: crate::Transform<'ast>,
    {
        ...
        let transformed = {
            match self {
                ...
                sqltk_parser::ast::Statement::Set(field0) => {
                    sqltk_parser::ast::Statement::Set(
                        field0.apply_transform_with_path(transformer, node_path)?,
                    )
                }
                ...
                sqltk_parser::ast::Statement::Case(field0) => {
                    sqltk_parser::ast::Statement::Case(
                        field0.apply_transform_with_path(transformer, node_path)?,
                    )
                }
                sqltk_parser::ast::Statement::If(field0) => {
                    sqltk_parser::ast::Statement::If(
                        field0.apply_transform_with_path(transformer, node_path)?,
                    )
                }
                sqltk_parser::ast::Statement::While(field0) => {
                    sqltk_parser::ast::Statement::While(
                        field0.apply_transform_with_path(transformer, node_path)?,
                    )
                }
                sqltk_parser::ast::Statement::Raise(field0) => {
                    sqltk_parser::ast::Statement::Raise(
                        field0.apply_transform_with_path(transformer, node_path)?,
                    )
                }
                ...
                sqltk_parser::ast::Statement::Open(field0) => {
                    sqltk_parser::ast::Statement::Open(
                        field0.apply_transform_with_path(transformer, node_path)?,
                    )
                }
                ...
                sqltk_parser::ast::Statement::AlterSession { set, session_params } => {
                ...
                sqltk_parser::ast::Statement::List(field0) => {
                    sqltk_parser::ast::Statement::List(
                        field0.apply_transform_with_path(transformer, node_path)?,
                    )
                }
                ...
                sqltk_parser::ast::Statement::Print(field0) => {
                    sqltk_parser::ast::Statement::Print(
                        field0.apply_transform_with_path(transformer, node_path)?,
                    )
                }
        ...
        let transformed = {
            match self {
                sqltk_parser::ast::StorageType::Disk => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::StorageType::Disk)?
                }
                sqltk_parser::ast::StorageType::Memory => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::StorageType::Memory)?
                }
            }
        };
        let transformed = transformer.transform(node_path, transformed)?;
...
impl<'ast> crate::Transformable<'ast> for sqltk_parser::ast::TableIndexHints {
        ...
        T: crate::Transform<'ast>,
    {
        node_path.push(self);
        let transformed = {
            let Self { hint_type, index_type, for_clause, index_names } = self;
            Self {
        ...
        let transformed = {
            match self {
                sqltk_parser::ast::TableIndexType::Index => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::TableIndexType::Index)?
                }
                sqltk_parser::ast::TableIndexType::Key => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::TableIndexType::Key)?
                }
            }
        };
        let transformed = transformer.transform(node_path, transformed)?;
...
impl<'ast> crate::Transformable<'ast> for sqltk_parser::ast::TableSample {
        ...
        T: crate::Transform<'ast>,
    {
        node_path.push(self);
        let transformed = {
            let Self { modifier, name, quantity, seed, bucket, offset } = self;
            Self {
...
impl<'ast> crate::Transformable<'ast> for sqltk_parser::ast::TableSampleQuantity {
        ...
        T: crate::Transform<'ast>,
    {
        node_path.push(self);
        let transformed = {
            let Self { parenthesized, value, unit } = self;
            Self {
        ...
        let transformed = {
            match self {
                sqltk_parser::ast::TriggerPeriod::For => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::TriggerPeriod::For)?
                }
        ...
        let transformed = {
            match self {
                ...
                sqltk_parser::ast::UnaryOperator::Hash => {
                    transformer
                        .transform(node_path, sqltk_parser::ast::UnaryOperator::Hash)?
                }
...
impl<'ast> crate::Transformable<'ast> for sqltk_parser::ast::XmlPassingArgument {
        ...
        T: crate::Transform<'ast>,
    {
        node_path.push(self);
        let transformed = {
            let Self { expr, alias, by_value } = self;
            Self {
                expr: expr.apply_transform_with_path(transformer, node_path)?,
                alias: alias.apply_transform_with_path(transformer, node_path)?,
        ...
        T: crate::Transform<'ast>,
    {
        ...
        let transformed = {
            match self {
                ...
                sqltk_parser::keywords::Keyword::AGGREGATE => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::keywords::Keyword::AGGREGATE,
                ...
                sqltk_parser::keywords::Keyword::ALERT => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::ALERT)?
                }
                ...
                sqltk_parser::keywords::Keyword::AUDIT => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::AUDIT)?
                }
                ...
                sqltk_parser::keywords::Keyword::AUTOEXTEND_SIZE => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::keywords::Keyword::AUTOEXTEND_SIZE,
                ...
                sqltk_parser::keywords::Keyword::AVG_ROW_LENGTH => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::keywords::Keyword::AVG_ROW_LENGTH,
                ...
                sqltk_parser::keywords::Keyword::BIND => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::BIND)?
                }
                ...
                sqltk_parser::keywords::Keyword::BLOCK => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::BLOCK)?
                }
                sqltk_parser::keywords::Keyword::BLOOM => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::BLOOM)?
                }
                ...
                sqltk_parser::keywords::Keyword::BOX => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::BOX)?
                }
                sqltk_parser::keywords::Keyword::BRIN => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::BRIN)?
                }
                ...
                sqltk_parser::keywords::Keyword::BUCKET => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::BUCKET)?
                }
                ...
                sqltk_parser::keywords::Keyword::CASES => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::CASES)?
                }
                ...
                sqltk_parser::keywords::Keyword::CATCH => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::CATCH)?
                }
                ...
                sqltk_parser::keywords::Keyword::CHARACTERISTICS => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::keywords::Keyword::CHARACTERISTICS,
                ...
                sqltk_parser::keywords::Keyword::CHECKSUM => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::CHECKSUM)?
                }
                sqltk_parser::keywords::Keyword::CIRCLE => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::CIRCLE)?
                }
                ...
                sqltk_parser::keywords::Keyword::CONNECT_BY_ROOT => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::keywords::Keyword::CONNECT_BY_ROOT,
                ...
                sqltk_parser::keywords::Keyword::DAYS => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::DAYS)?
                }
                ...
                sqltk_parser::keywords::Keyword::DELAY_KEY_WRITE => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::keywords::Keyword::DELAY_KEY_WRITE,
                ...
                sqltk_parser::keywords::Keyword::DOMAIN => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::DOMAIN)?
                }
                ...
                sqltk_parser::keywords::Keyword::ELSEIF => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::ELSEIF)?
                }
                ...
                sqltk_parser::keywords::Keyword::ENGINE_ATTRIBUTE => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::keywords::Keyword::ENGINE_ATTRIBUTE,
                ...
                sqltk_parser::keywords::Keyword::EVOLVE => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::EVOLVE)?
                }
                ...
                sqltk_parser::keywords::Keyword::EXTEND => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::EXTEND)?
                }
                ...
                sqltk_parser::keywords::Keyword::GIN => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::GIN)?
                }
                sqltk_parser::keywords::Keyword::GIST => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::GIST)?
                }
                ...
                sqltk_parser::keywords::Keyword::HUGEINT => {
                    transformer
                ...
                sqltk_parser::keywords::Keyword::IMPORT => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::IMPORT)?
                }
                ...
                sqltk_parser::keywords::Keyword::INHERITS => {
                    transformer
                ...
                sqltk_parser::keywords::Keyword::INSERT_METHOD => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::keywords::Keyword::INSERT_METHOD,
                ...
                sqltk_parser::keywords::Keyword::IO => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::IO)?
                }
                ...
                sqltk_parser::keywords::Keyword::KEY_BLOCK_SIZE => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::keywords::Keyword::KEY_BLOCK_SIZE,
                ...
                sqltk_parser::keywords::Keyword::LINE => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::LINE)?
                }
                ...
                sqltk_parser::keywords::Keyword::LIST => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::LIST)?
                }
                ...
                sqltk_parser::keywords::Keyword::LOG => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::LOG)?
                }
                ...
                sqltk_parser::keywords::Keyword::LS => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::LS)?
                }
                sqltk_parser::keywords::Keyword::LSEG => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::LSEG)?
                }
                ...
                sqltk_parser::keywords::Keyword::MANAGE => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::MANAGE)?
                }
                ...
                sqltk_parser::keywords::Keyword::MAX_ROWS => {
                    transformer
                ...
                sqltk_parser::keywords::Keyword::MESSAGE => {
                    transformer
                ...
                sqltk_parser::keywords::Keyword::METRIC => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::METRIC)?
                }
                ...
                sqltk_parser::keywords::Keyword::MINUS => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::MINUS)?
                }
                ...
                sqltk_parser::keywords::Keyword::MIN_ROWS => {
                    transformer
                ...
                sqltk_parser::keywords::Keyword::MONTHS => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::MONTHS)?
                }
                ...
                sqltk_parser::keywords::Keyword::NAMES => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::NAMES)?
                }
                ...
                sqltk_parser::keywords::Keyword::NFC => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::NFC)?
                }
                sqltk_parser::keywords::Keyword::NFD => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::NFD)?
                }
                sqltk_parser::keywords::Keyword::NFKC => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::NFKC)?
                }
                sqltk_parser::keywords::Keyword::NFKD => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::NFKD)?
                }
                ...
                sqltk_parser::keywords::Keyword::OFF => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::OFF)?
                }
                ...
                sqltk_parser::keywords::Keyword::OUTPUT => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::OUTPUT)?
                }
                ...
                sqltk_parser::keywords::Keyword::PACK_KEYS => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::keywords::Keyword::PACK_KEYS,
                ...
                sqltk_parser::keywords::Keyword::PASSING => {
                    transformer
                ...
                sqltk_parser::keywords::Keyword::POINT => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::POINT)?
                }
                ...
                sqltk_parser::keywords::Keyword::POOL => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::POOL)?
                }
                ...
                sqltk_parser::keywords::Keyword::PRINT => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::PRINT)?
                }
                ...
                sqltk_parser::keywords::Keyword::PUBLIC => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::PUBLIC)?
                }
                ...
                sqltk_parser::keywords::Keyword::RAISE => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::RAISE)?
                }
                ...
                sqltk_parser::keywords::Keyword::REMOVE => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::REMOVE)?
                }
                ...
                sqltk_parser::keywords::Keyword::RESOURCE => {
                    transformer
                ...
                sqltk_parser::keywords::Keyword::RM => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::RM)?
                }
                ...
                sqltk_parser::keywords::Keyword::ROW_FORMAT => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::keywords::Keyword::ROW_FORMAT,
                ...
                sqltk_parser::keywords::Keyword::SAMPLE => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::SAMPLE)?
                }
                ...
                sqltk_parser::keywords::Keyword::SEED => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::SEED)?
                }
                ...
                sqltk_parser::keywords::Keyword::SHARED => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::SHARED)?
                }
                ...
                sqltk_parser::keywords::Keyword::SIGNED => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::SIGNED)?
                }
                ...
                sqltk_parser::keywords::Keyword::SPGIST => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::SPGIST)?
                }
                ...
                sqltk_parser::keywords::Keyword::STATS_PERSISTENT => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::keywords::Keyword::STATS_PERSISTENT,
                ...
                sqltk_parser::keywords::Keyword::STORAGE => {
                    transformer
                ...
                sqltk_parser::keywords::Keyword::STRAIGHT_JOIN => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::keywords::Keyword::STRAIGHT_JOIN,
                ...
                sqltk_parser::keywords::Keyword::SUBSTR => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::SUBSTR)?
                }
                ...
                sqltk_parser::keywords::Keyword::TABLESPACE => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::keywords::Keyword::TABLESPACE,
                ...
                sqltk_parser::keywords::Keyword::TASK => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::TASK)?
                }
                ...
                sqltk_parser::keywords::Keyword::TIMESTAMP_NTZ => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::keywords::Keyword::TIMESTAMP_NTZ,
                ...
                sqltk_parser::keywords::Keyword::TRACE => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::TRACE)?
                }
                ...
                sqltk_parser::keywords::Keyword::TRY => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::TRY)?
                }
                ...
                sqltk_parser::keywords::Keyword::UBIGINT => {
                    transformer
                ...
                sqltk_parser::keywords::Keyword::UHUGEINT => {
                    transformer
                ...
                sqltk_parser::keywords::Keyword::UNSET => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::UNSET)?
                }
                ...
                sqltk_parser::keywords::Keyword::USMALLINT => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::keywords::Keyword::USMALLINT,
                ...
                sqltk_parser::keywords::Keyword::UTINYINT => {
                    transformer
                ...
                sqltk_parser::keywords::Keyword::VARBIT => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::VARBIT)?
                }
                ...
                sqltk_parser::keywords::Keyword::VOLUME => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::VOLUME)?
                }
                ...
                sqltk_parser::keywords::Keyword::WEEKS => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::WEEKS)?
                }
                ...
                sqltk_parser::keywords::Keyword::WHILE => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::WHILE)?
                }
                ...
                sqltk_parser::keywords::Keyword::XMLNAMESPACES => {
                    transformer
                        .transform(
                            node_path,
                            sqltk_parser::keywords::Keyword::XMLNAMESPACES,
                ...
                sqltk_parser::keywords::Keyword::XMLTABLE => {
                    transformer
                ...
                sqltk_parser::keywords::Keyword::YEARS => {
                    transformer
                        .transform(node_path, sqltk_parser::keywords::Keyword::YEARS)?
                }
