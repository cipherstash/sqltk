...
use sqltk_parser::ast::DateTimeField::Seconds;
...
fn parse_select_table_with_index_hints() {
    ...
    assert_eq!(
        ...
        vec![TableWithJoins {
            relation: TableFactor::Table {
                name: ObjectName(vec![sqltk_parser::ast::ObjectNamePart::Identifier(
                    Ident::new("T")
                )]),
                alias: Some(TableAlias {
                    name: Ident::new("USE"),
